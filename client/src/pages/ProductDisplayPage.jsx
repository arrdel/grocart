...
const ProductDisplayPage = () => {
  ...
  return (
    <section className="container mx-auto p-4 grid lg:grid-cols-2 bg-gradient-to-r from-green-50 to-orange-50 min-h-screen">
      <div className="">
      ...
      <div className="p-4 lg:pl-7 text-base lg:text-lg">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            {data.discount && (
              <p className="line-through">{RenderPriceInUSD(data.price)}</p>
            )}
            {data.discount && (
        ...
        <h2 className="font-semibold">Why shop from GroCart? </h2>
        <div>
